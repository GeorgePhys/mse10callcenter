package callcenter.web.components.renderers;
...
import callcenter.web.filter.MultipartRequest;
...
public class FileRenderer extends TextRenderer {
	...
	if (context.getExternalContext().getRequest() instanceof MultipartRequest) {
	    file = ((MultipartRequest) context.getExternalContext()
		    .getRequest()).getFile(clientId);
	}
