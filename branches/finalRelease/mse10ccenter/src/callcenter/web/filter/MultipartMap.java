...
public class MultipartMap extends HashMap<String, Object> {
	...
	this(multipartRequest, new MultipartConfigElement(servlet.getClass()
		.getAnnotation(MultipartConfig.class)).getLocation(), true);
    }
     ...
     * Global constructor.
     */
    private MultipartMap(HttpServletRequest multipartRequest, String location,
	    boolean multipartConfigured) throws ServletException, IOException {
	...
	if (value instanceof File) {
	    throw new IllegalArgumentException(
		    "This is a File field. Use #getFile() instead.");
	}
	String[] values = (String[]) value;
	...
	if (multipartConfigured) {
	    part.write(file.getName()); // Will be written to the very same
					// File.
	} else {
